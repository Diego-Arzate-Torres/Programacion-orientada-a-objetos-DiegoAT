...
public class SrEnginner extends JrEngineer implements Interviewer {
     ...
     * @param timeInCompany
     */
    public SrEnginner( String name, String lastName, int age, int phoneNum, int socialSecurityNum, String lenguages, int timeInCompany){
           super(name, lastName, age, phoneNum, socialSecurityNum, lenguages, timeInCompany);
